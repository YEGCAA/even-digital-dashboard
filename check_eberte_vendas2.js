...
async function findEberteVendas2() {
    const { data: vData } = await supabase.from('Vendas_2').select('*').ilike('nome', '%Eberte%');
    console.log('Eberte in Vendas_2:', JSON.stringify(vData, null, 2));
}
findEberteVendas2();
