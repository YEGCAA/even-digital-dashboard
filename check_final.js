...
async function checkFinal() {
    ...
    let sum = 0;
    console.log('--- Vendas_2 (Matched Ganhos) ---');
    v2.forEach(r => {
        ...
        const isMatched = stage1.includes('concluid') || stage1.includes('ganh') ||
            stage2.includes('concluid') || stage2.includes('ganh') ||
            status.includes('ganh') || id1 === '14';
